...
def parsePMTSection(filehandle, k):
    ...
    while (n>0):
        ...
        descriptor_Tag1 = readFile(filehandle, m, 1)
        descriptor_length = readFile(filehandle, m+3, 1)
        
       
        
       
        
        print 'descriptor_Tag1= 0x%X , descriptor_tag = %d, descriptor_length = %d' %(descriptor_Tag1, descriptor_tag, descriptor_length)
    ...
    while (length > 0):
        ...
        while (n>0):
            ...
            bitrate_value1 = readFile(filehandle, m+1, 4)
            bitrate_value= bitrate_value1&0x3fffff
            
            
           
            #IP = readFile(filehandle, m+4, 1)
            
            print 'descriptor_tag = %d, descriptor_length = %d, bitrate_value =%d' %(descriptor_tag, descriptor_length, bitrate_value)
            n -= descriptor_length + 2
            m += descriptor_length + 2
